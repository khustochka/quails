...
Locus.transaction do
  ...
  europe = Locus.create!(name_en: "Europe", name_uk: "Європа", loc_type: "special", public_index: 7)
  north_america = Locus.create!(name_en: "North America", name_uk: "Північна Америка", loc_type: "special", public_index: 8)
  ...
  kyiv_obl = Locus.create!(name_en: "Kyiv Oblast", name_uk: "Київська область", loc_type: "subdivision1", iso_code: "32", parent: ukraine, public_index: 3)
  kherson_obl = Locus.create!(name_en: "Kherson Oblast", name_uk: "Херсонська область", loc_type: "subdivision1", iso_code: "65", parent: ukraine, public_index: 4)
  ...
  scotland = Locus.create!(name_en: "Scotland", name_uk: "Шотландія", loc_type: "subdivision1", parent: uk)

  manitoba = Locus.create!(name_en: "Manitoba", name_uk: "Манітоба", loc_type: "subdivision1", iso_code: "MB", parent: canada, public_index: 11)
  winnipeg = Locus.create!(name_en: "Winnipeg", name_uk: "Вінніпег", loc_type: "city", parent: manitoba, public_index: 12)

  ny = Locus.create!(name_en: "New York", name_uk: "шт. Нью-Йорк", loc_type: "subdivision1", iso_code: "NY", parent: usa)
