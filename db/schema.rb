...
ActiveRecord::Schema[8.1].define(version: 2025_12_05_222823) do
  ...
  create_table "comments", id: :serial, force: :cascade do |t|
    ...
    t.boolean "needs_email_release", default: false, null: false
    t.integer "parent_id"
  ...
  create_table "media", id: :serial, force: :cascade do |t|
    ...
    t.index ["spot_id"], name: "index_media_on_spot_id"
  end
  ...
  create_table "url_synonyms", id: :serial, force: :cascade do |t|
    ...
    t.index ["species_id"], name: "index_url_synonyms_on_species_id"
  end
  ...
  add_foreign_key "url_synonyms", "species"
end
