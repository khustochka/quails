...
$(function () {
  var textarea = $('.wiki_field')[0],
      ...
      img_insert_button = $("<button>", {text: "{{^image}}", id: "insert_img_tag", type: "button"}),
      post_insert_button = $("<button>", {text: "{{#post}}", id: "insert_post_tag", type: "button"});
  ...
  img_insert_button.click(function () {
    insertTags(textarea, '{{^', '}}', 'img_slug');
  });

  post_insert_button.click(function () {
