...
class PostsCollectionsTest < ActionController::TestCase
  ...
  should 'show correct Earlier Posts link if limit is on the month border' do
    blogpost1 = Factory.create(:post, :created_at => '2007-12-06 13:14:15', :code => 'post-one')
    blogpost2 = Factory.create(:post, :created_at => '2007-11-06 13:14:15', :code => 'post-three')
    blogpost3 = Factory.create(:post, :created_at => '2007-12-05 13:14:15', :code => 'post-two')
    blogpost4 = Factory.create(:post, :created_at => '2007-10-06 13:14:15', :code => 'post-four')
    blogpost5 = Factory.create(:post, :created_at => '2007-10-05 13:14:15', :code => 'post-five')
    get :index
    assert_response :success
  ...
  should 'show correct Earlier Posts link if limit is inside the month' do
    ...
    blogpost2 = Factory.create(:post, :created_at => '2007-11-06 13:14:15', :code => 'post-three')
    blogpost3 = Factory.create(:post, :created_at => '2007-12-05 13:14:15', :code => 'post-two')
    blogpost4 = Factory.create(:post, :created_at => '2007-11-05 13:14:15', :code => 'post-four')
    blogpost5 = Factory.create(:post, :created_at => '2007-11-04 13:14:15', :code => 'post-five')
    get :index
    assert_response :success
    assert_select 'h2.post-title', 3
    assert_select "h2 a[href=#{public_post_path(blogpost1)}]"
  ...
  should 'show full month and correct Earlier Posts link if the last month exceeds the limit' do
    blogpost1 = Factory.create(:post, :created_at => '2007-11-30 13:14:15', :code => 'post-one')
    blogpost2 = Factory.create(:post, :created_at => '2007-11-06 13:14:15', :code => 'post-three')
    blogpost3 = Factory.create(:post, :created_at => '2007-11-25 13:14:15', :code => 'post-two')
    blogpost4 = Factory.create(:post, :created_at => '2007-10-05 13:14:15', :code => 'post-four')
    blogpost5 = Factory.create(:post, :created_at => '2007-11-04 13:14:15', :code => 'post-five')
    blogpost6 = Factory.create(:post, :created_at => '2007-11-02 13:14:15', :code => 'post-six')
    get :index
    assert_response :success
