...
class PostTest < ActiveSupport::TestCase
  ...
  test "autoset empty slug for shouts" do
    blogpost = build(:post, status: "SHOT", post_core: build(:post_core, slug: ""))
    assert_predicate blogpost, :valid?
    assert_not_empty blogpost.slug
  end

  test "autogenerated shout slugs do not clash" do
    blogpost1 = create(:post, status: "SHOT", post_core: build(:post_core, slug: ""))
    blogpost2 = create(:post, status: "SHOT", post_core: build(:post_core, slug: ""))
