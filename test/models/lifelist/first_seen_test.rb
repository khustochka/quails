...
module Lifelist
  class FirstSeenTest < ActiveSupport::TestCase
    ...
    setup do
      @obs = [
          create(:observation, species: species(:colliv), card: create(:card, observ_date: "2008-05-22")),
          create(:observation, species: species(:merser), card: create(:card, observ_date: "2008-10-18")),
          create(:observation, species: species(:colliv), card: create(:card, observ_date: "2008-11-01")),
          create(:observation, species: species(:parmaj), card: create(:card, observ_date: "2009-01-01")),
          create(:observation, species: species(:pasdom), card: create(:card, observ_date: "2009-01-01")),
          create(:observation, species: species(:colliv), card: create(:card, observ_date: "2009-10-18")),
          create(:observation, species: species(:parmaj), card: create(:card, observ_date: "2009-11-01")),
          create(:observation, species: species(:pasdom), card: create(:card, observ_date: "2009-12-01", locus: loci(:nyc))),
          create(:observation, species: species(:parmaj), card: create(:card, observ_date: "2009-12-31")),
          create(:observation, species: species(:colliv), card: create(:card, observ_date: "2010-03-10", locus: loci(:nyc))),
          create(:observation, species: species(:pasdom), card: create(:card, observ_date: "2010-04-16", locus: loci(:nyc))),
          create(:observation, species: species(:colliv), card: create(:card, observ_date: "2010-07-27", locus: loci(:nyc))),
          create(:observation, species: species(:pasdom), card: create(:card, observ_date: "2010-09-10")),
          create(:observation, species: species(:carlis), card: create(:card, observ_date: "2010-10-13"))
      ]
    end
