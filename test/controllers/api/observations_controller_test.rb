...
module API
  class ObservationsControllerTest < ActionDispatch::IntegrationTest
    test "should get index" do
      create(:observation)
      get api_observations_url, params: { format: :json }, headers: { "HTTP_AUTHORIZATION" => "Token test1234" }
    ...
    test "pagination" do
      ...
      get api_observations_url, params: { format: :json, page: 2, per_page: 2 }, headers: { "HTTP_AUTHORIZATION" => "Token test1234" }
