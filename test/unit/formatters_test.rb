...
class FormattersTest < ActionView::TestCase
  ...
  test "Post with species link" do
    ...
    assert_equal "<p>This is a <a href=\"/species/Parus_caeruleus\" class=\"sp_link\">Blue Tut</a></p>", post.formatted.for_site.text
  end

  test "Post with unknown species" do
    post = create(:post, text: "This is a [Frodo hobbitana]")
    assert_equal "<p>This is a <i class=\"sci_name\">Frodo hobbitana</i></p>", post.formatted.for_site.text
  end
  ...
  test "Post with link to another post" do
    ...
    assert_equal "<p>This is a <a href=\"/#{post1.year}/#{post1.month}/post_for_link\">post</a></p>", post.formatted.for_site.text
  end
