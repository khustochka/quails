...
class WikiFilterTest < ActionDispatch::IntegrationTest
  ...
  test 'properly parse species by code {{Wryneck|jyntor}}' do
    assert_equal %Q(<a class="sp_link" href="/species/Jynx_torquilla">Wryneck</a>),
  ...
  test 'properly parse species in the string' do
    assert_equal %Q(Those were <a class="sp_link" href="/species/Jynx_torquilla">Wrynecks</a>!),
                 transform('Those were {{Wrynecks|jyntor}}!')
  end

  test 'Add English name after species link' do
    assert_equal %Q(<a class="sp_link" href="/species/Jynx_torquilla">Вертишейка</a> (Wryneck)),
