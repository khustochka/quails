...
class PostTest < ActiveSupport::TestCase
  ...
  test 'calculate previous month correctly (one having posts) even for month with no posts' do
    blogpost1 = FactoryGirl.create(:post, :face_date => '2010-02-06 13:14:15', :code => 'post-one')
    blogpost2 = FactoryGirl.create(:post, :face_date => '2009-11-06 13:14:15', :code => 'post-two')
    blogpost3 = FactoryGirl.create(:post, :face_date => '2009-10-06 13:14:15', :code => 'post-tri')
  ...
  test 'calculate next month correctly (one having posts) even for month with no posts' do
    blogpost1 = FactoryGirl.create(:post, :face_date => '2010-02-06 13:14:15', :code => 'post-one')
    blogpost2 = FactoryGirl.create(:post, :face_date => '2009-11-06 13:14:15', :code => 'post-two')
    blogpost1 = FactoryGirl.create(:post, :face_date => '2010-03-06 13:14:15', :code => 'post-tri')
  ...
  test 'do not delete associated observations on post destroy' do
    blogpost = FactoryGirl.create(:post, :face_date => '2010-02-06 13:14:15', :code => 'post-one')
    observation = FactoryGirl.create(:observation, :post => blogpost)
    blogpost.destroy
