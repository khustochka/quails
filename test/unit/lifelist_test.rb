...
class LifelistTest < ActiveSupport::TestCase
  ...
  test '(OLD) not miss species from lifelist if it was first seen not by me' do
    FactoryGirl.create(:observation, :species => Species.find_by_code!('pasdom'), :observ_date => "2008-06-20")
    FactoryGirl.create(:observation, :species => Species.find_by_code!('melgal'), :observ_date => "2009-06-18", :mine => false)
    observ   = FactoryGirl.create(:observation, :species => Species.find_by_code!('melgal'), :observ_date => "2010-06-18")
...
#    FactoryGirl.create(:observation, :species => Species.find_by_code!('melgal'), :observ_date => "2009-06-18", :locus => Locus.find_by_code!('brovary'))
#    FactoryGirl.create(:observation, :species => Species.find_by_code!('pasdom'), :observ_date => "2009-06-18")
#    FactoryGirl.create(:observation, :species => Species.find_by_code!('melgal'), :observ_date => "2009-06-18", :locus => Locus.find_by_code!('kiev'))
...
#  end
  ...
  test '(OLD) not place into lifelist an observation with lower id instead of an earlier date' do
    FactoryGirl.create(:observation, :species => Species.find_by_code!('pasdom'), :observ_date => "2010-06-20")
    obs = FactoryGirl.create(:observation, :species => Species.find_by_code!('pasdom'), :observ_date => "2010-06-18")
  ...
  test '(OLD) order lifelist correctly' do
    ...
    FactoryGirl.create(:observation, :species => Species.find_by_code!('anacly'), :observ_date => "2007-07-18")
    FactoryGirl.create(:observation, :species => Species.find_by_code!('embcit'), :observ_date => "2009-08-09")
  ...
  test '(OLD) not miss species from lifelist if its first observation has no post' do
    ...
    FactoryGirl.create(:observation, :species => Species.find_by_code!('anapla'), :observ_date => "2009-08-09", :post => blogpost)
    observ = FactoryGirl.create(:observation, :species => Species.find_by_code!('anacly'), :observ_date => "2007-07-18")
    FactoryGirl.create(:observation, :species => Species.find_by_code!('anacly'), :observ_date => "2009-08-09", :post => blogpost)
