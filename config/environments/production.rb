...
Rails.application.configure do
  ...
  config.public_file_server.enabled = ENV['RAILS_SERVE_STATIC_FILES'].present? || Quails.env.nil?

  # Compress CSS using a preprocessor.
  # config.assets.css_compressor = :sass

  # Intentionally not compressing JS: gzip + caching + I want them to be readable
